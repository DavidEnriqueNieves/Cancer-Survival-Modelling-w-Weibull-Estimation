...
# -1038.706
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48,1500,0.0245),iterlim=20,tol=0.0001, control=list(printLevel=2))

# ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(49,1500,0.0245),iterlim=20,tol=0.0001, control=list(printLevel=2))

# -1038.546
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48,1500,0.0245),iterlim=20,tol=0.0001, control=list(printLevel=2))

# -1054
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48,1500,0.026),iterlim=20,tol=0.0001, control=list(printLevel=2))

# -1037.584
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48,1500,0.025),iterlim=20,tol=0.0001, control=list(printLevel=2))

# -1038.481
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48.005,1500,0.0245191),iterlim=20,tol=0.0001, control=list(printLevel=2))

# -1057
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(47.85,1500,0.023),iterlim=20,tol=0.0001, control=list(printLevel=2))
# -1039
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(47.3,1500,0.0245191),iterlim=20,tol=0.0001, control=list(printLevel=2))

# error
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(50,1500,0.024),iterlim=20,tol=0.0001, control=list(printLevel=2))
...
# -1038.19
ml <- maxLik( logLik =log_likelihood, grad=gradient, start=c(48.0,1500,0.027),iterlim=20,tol=0.0001, control=list(printLevel=2))
